...
INSERT INTO map (
    ...
    sr, bpm, drain_time, hp, od, index, comment
)
VALUES (
...
VALUES (
           1, 1, true, 4334158, 'HiTECH Bass Loops Vol.1', '[6K] Stage 1: Erraticity', 'lapix',
...
VALUES (
           1, 1, true, 4334134, 'Firmament Castle "Velier"', '[6K] Stage 2: Welkin', 'Uetsu Shi',
...
VALUES (
           1, 3, true, 4334121, 'Jikai ~ Paganelope', '[6K] Stage 3: Lust', 'Warak',
...
VALUES (
           1, 2, true, 4334124, 'Woodfairies', '[6K] Stage 4: Yearning', 'Aethoro',
...
VALUES (
           1, 1, true, 4334151, 'Nhelv', '[6K] Stage 5: NERVE', 'Silentroom',
...
VALUES (
           1, 1, true, 4334143, 'ELPIS', '[6K] Stage 6: Hope', 'dj TAKA',
...
VALUES (
           10, 4, true, 4253502, 'sha (Cut Ver.)', '[4K] Stage 1: blake', 'sakuraburst',
...
VALUES (
           10, 1, true, 4253751, 'ultra-blazures (Cut Ver.)', '[4K] Stage 2: amalgam', 'Frums',
...
VALUES (
           10, 3, true, 4266621, 'Ten''imuhou', '[4K] Absolute', 'xi',
...
VALUES (
           10, 2, true, 4253496, 'End of Fairytale', '[4K] Stage 4: Parable', 'technoplanet feat. Haruno',
...
VALUES (
           10, 2, true, 4253649, 'Ultra Happy Miracle Bazoooooka!!', '[4K] Stage 5: Overjoy',
...
VALUES (
           10, 3, true, 4253513, 'onslaught -Retaliation of Bahamut-', '[4K] Stage 6: Massacre', 'Camellia',
...
VALUES (
           10, 1, true, 4253489, 'AMEN KATAGIRI GENERATION', '[4K] Stage 7: Revival', 'katagiri',
...
VALUES (
           10, 1, true, 4253740, 'Xuasar Charge', '[4K] A Sea of Stars', 'Kou!',
...
VALUES (
           9, 1, true, 4283526, 'Gypsophila', '[4K] blossom 1.1x (166bpm)', 'linear ring with RNAcid',
...
VALUES (
           9, 1, true, 4272125, 'Cosmo Station', '[4K] Orbis x1.1', 'seatrus',
...
VALUES (
           9, 1, true, 4281865, 'Edison', '[4K] Challenge (Edit) 1.1x (146bpm)', 'EvOke',
...
VALUES (
           9, 1, true, 4284901, 'Break The Silence', '[4K] Challenge', 'Camellia',
...
VALUES (
           9, 1, true, 4284906, 'Baka Mitai (Cut Ver.)', '[4K] Ska''s n no. .', 'Kazuma Kiryu (CV: Takaya Kuroda)',
...
VALUES (
           9, 1, true, 4284888, 'Nisemono', '[4K] Impostor (cut 1.05x)', 'Frums',
...
VALUES (
           9, 3, true, 4284664, 'Bloomin''', '[4K] Flowerin''', 'MisoilePunch -Forever-',
...
VALUES (
           9, 3, true, 4284920, 'Upload Your Mind :: Download My Soul', '[4K] Multidimensional', 'Camellia',
...
VALUES (
           9, 3, true, 4284700, 'Calculator', '[4K] .857142', 'M-O-T-U',
...
VALUES (
           9, 2, true, 4284564, 'Astra Walkthrough', '[4K] Faded Stars', 'paraoka',
...
VALUES (
           9, 2, true, 4284669, 'Heaven''s Fall', '[4K] Firmaments', 'Helblinde',
...
VALUES (
           9, 2, true, 4284918, 'Erinyes', '[4K] Enigma', 'Toromaru',
...
VALUES (
           9, 4, true, 4284932, 'Sample enSemble', '[4K] SV asSemble', 'AltVoid',
...
VALUES (
           9, 4, true, 4284940, 'Cyber Thunder Cider', '[4K] ??', 'EZFG',
...
VALUES (
           9, 5, true, 4284926, 'Drenched in Air', '[4K] Submerge', 'Camellia feat. Ninomae Ina''nis',
